import{r as M,j as f}from"./iframe-J19JpNUf.js";import{f as s}from"./RLCrud-BDpxjJkG.js";import"./RLRadioGroup-BKUkuM0B.js";import"./preload-helper-C1FmrZbK.js";import"./index-DF6ZvJcA.js";const y={title:"Components/Date picker",component:s,tags:["autodocs"],argTypes:{selectionMode:{control:"select",options:["single","range","multiple",void 0]}},args:{},render:e=>{const[b,v]=M.useState(null);return f.jsx(s,{...e,value:b,onChange:T=>v(T)})}},a={args:{label:"Date of birth (RLDatePicker)",rules:[{validateFn:e=>!!e,message:"The value is required"},{validateFn:e=>e.getTime()<new Date().getTime(),message:"Oh...it seems you are not born yet!"}]}},t={args:{label:"Date",name:"DateInput",placeholder:"Select a date...",selectionMode:"multiple"}},r={args:{label:"Date",name:"DateInput",placeholder:"Select a date...",selectionMode:"range"}},n={args:{label:"Date",name:"DateInput",placeholder:"Select a date and time...",withTime:!0}};var o,l,i;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
